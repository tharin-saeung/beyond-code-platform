...
export default function RegisterForm({ error, message }: RegisterFormProps) {
      ...
      <div className="z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8 text-center animate-[fade-in_0.5s_ease-out]">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Start your journey on the modern learning platform
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  required
                  defaultValue=""
                  className="w-full appearance-none bg-slate-950/80 border border-slate-800 text-slate-100 rounded-xl py-3 pl-11 pr-10 focus:outline-none focus:ring-2 focus:ring-violet-500/40 focus:border-violet-500 transition-all duration-200 text-sm cursor-pointer"
                >
